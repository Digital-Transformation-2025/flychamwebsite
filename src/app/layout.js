...
export const metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/favicon.ico', sizes: '16x16', type: 'image/png' },   // 16x16 PNG
      { url: '/favicon.ico', sizes: '32x32', type: 'image/png' },   // 32x32 PNG
      { url: '/favicon.ico', type: 'image/svg+xml' },  // SVG format
    ],
    apple: [{ url: '/favicon.ico', sizes: '180x180' }],  // Apple icon
